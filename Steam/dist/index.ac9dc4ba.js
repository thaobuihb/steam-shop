...
function myFunction() {
    let lastGuess;
    let num = prompt("Please enter random number:");
    if (num == null || num == "") lastGuess = "User cancelled the prompt.";
    else lastGuess = num;
    parseInt(lastGuess, 10);
    document.getElementById("demo").innerHTML = lastGuess;
}
...
function updatePage() {
    ...
    if (isCorrect) correct.innerHTML = CORRECT_MESSAGE;
    else correct.innerHTML = INCORRECT_MESSAGE;
